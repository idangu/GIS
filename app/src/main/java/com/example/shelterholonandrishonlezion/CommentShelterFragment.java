...
public class CommentShelterFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        DatabaseReference firebaseDatabase = FirebaseDatabase.getInstance("https://gisproject-b2f5d-default-rtdb.firebaseio.com")
        ...
        firebaseDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.getValue().toString().equals("S")) {
                    DatabaseReference ref = FirebaseDatabase.getInstance("https://gisproject-b2f5d-default-rtdb.firebaseio.com")
                    ...
                    ref.child(id).child(idComment).setValue(map).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                ...
                                FirebaseDatabase.getInstance("https://gisproject-b2f5d-default-rtdb.firebaseio.com").getReference().child("shelter")
    ...
    private void getComment(){
        FirebaseDatabase.getInstance("https://gisproject-b2f5d-default-rtdb.firebaseio.com").getReference()
